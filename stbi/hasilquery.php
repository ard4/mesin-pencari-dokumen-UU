...
<br>
<h2><center>Hasil Pencarian Kata Kunci</center></h2>
<br>
...
$username = "id9106974_sutardi";
$password = "sutardi";
$dbname = "id9106974_dbstbi";
$katakunci="";
// Create connection
$conn = new mysqli($servername, $username, $password, $dbname);
// Check connection
$conn=mysqli_connect('localhost','id9106974_sutardi','sutardi','id9106974_dbstbi');
